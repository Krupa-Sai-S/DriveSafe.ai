...
const safetyFacts = [
  ...
  "DriveSafe AI processes your camera feed entirely on your device",
];
    ...
    <div className="min-h-screen">
      ...
      <section className="container mx-auto max-w-7xl px-4 pb-16 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          {[
            { step: "01", icon: ShieldCheck, title: "Open DriveSafe AI", desc: "Launch in your browser. No downloads, no account required.", color: "text-blue-400", bg: "bg-blue-400/10 border-blue-400/20" },
      ...
      <section className="container mx-auto max-w-7xl px-4 pb-16 md:px-6 lg:px-8">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-60px" }}
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground max-w-md mx-auto text-sm">DriveSafe AI processes everything locally — no servers, no cloud, no data collection.</p>
          </div>
